...
namespace DnD_CharacterBuilder_Library
{
    public class HtmlLayout
    {
        public string htmlCode = 
            ...
            $"<div class=\"proficiencybonus box\"><div class=\"label-container\"><label for=\"proficiencybonus\">Proficiency Bonus</label></div><input name=\"proficiencybonus\" value= \"+{Method.ProfBonus(CharacterDTO.CLvl)}\"></div>" +
            "<div class=\"saves list-section box\">" +
            "<ul>" +
            $"<li><label for=\"Strength-save\">Strength</label><input name=\"Strength-save\" value={AbilityDTO.StrMod} type=\"text\"><input name=\"Strength-save-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Dexterity-save\">Dexterity</label><input name=\"Dexterity-save\" value={AbilityDTO.DexMod} type=\"text\"><input name=\"Dexterity-save-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Constitution-save\">Constitution</label><input name=\"Constitution-save\" value={AbilityDTO.ConMod} type=\"text\"><input name=\"Constitution-save-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Intelligence-save\">Intelligence</label><input name=\"Intelligence-save\" value={AbilityDTO.IntMod} type=\"text\"><input name=\"Intelligence-save-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Wisdom-save\">Wisdom</label><input name=\"Wisdom-save\" value={AbilityDTO.WisMod} type=\"text\"><input name=\"Wisdom-save-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Charisma-save\">Charisma</label><input name=\"Charisma-save\" value={AbilityDTO.ChaMod} type=\"text\"><input name=\"Charisma-save-prof\" type=\"checkbox\"></li>" +
            "</ul>" +
            "<div class=\"label\">Saving Throws</div></div>" +
            "<div class=\"skills list-section box\">" +
            "<ul>" +
            $"<li><label for=\"Acrobatics\">Acrobatics <span class=\"skill\">(Dex)</span></label><input name=\"Acrobatics\" value={Method.SkillBonus(AbilityDTO.DexMod,SkillsDTO.Acrobatics)} type=\"text\"><input name=\"Acrobatics-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Animal Handling\">Animal Handling <span class=\"skill\">(Wis)</span></label><input name=\"Animal Handling\" value={Method.SkillBonus(AbilityDTO.WisMod, SkillsDTO.AnimalHandling)} type=\"text\"><input name=\"Animal Handling-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Arcana\">Arcana <span class=\"skill\">(Int)</span></label><input name=\"Arcana\" value={Method.SkillBonus(AbilityDTO.IntMod, SkillsDTO.Arcana)} type=\"text\"><input name=\"Arcana-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Athletics\">Athletics <span class=\"skill\">(Str)</span></label><input name=\"Athletics\" value={Method.SkillBonus(AbilityDTO.StrMod, SkillsDTO.Athletics)} type=\"text\"><input name=\"Athletics-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Deception\">Deception <span class=\"skill\">(Cha)</span></label><input name=\"Deception\" value={Method.SkillBonus(AbilityDTO.ChaMod, SkillsDTO.Deception)} type=\"text\"><input name=\"Deception-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"History\">History <span class=\"skill\">(Int)</span></label><input name=\"History\" value={Method.SkillBonus(AbilityDTO.IntMod, SkillsDTO.History)} type=\"text\"><input name=\"History-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Insight\">Insight <span class=\"skill\">(Wis)</span></label><input name=\"Insight\" value={Method.SkillBonus(AbilityDTO.WisMod, SkillsDTO.Insight)} type=\"text\"><input name=\"Insight-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Intimidation\">Intimidation <span class=\"skill\">(Cha)</span></label><input name=\"Intimidation\" value={Method.SkillBonus(AbilityDTO.ChaMod, SkillsDTO.Intimidation)} type=\"text\"><input name=\"Intimidation-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Investigation\">Investigation <span class=\"skill\">(Int)</span></label><input name=\"Investigation\" value={Method.SkillBonus(AbilityDTO.IntMod, SkillsDTO.Investigation)} type=\"text\"><input name=\"Investigation-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Medicine\">Medicine <span class=\"skill\">(Wis)</span></label><input name=\"Medicine\" value={Method.SkillBonus(AbilityDTO.WisMod, SkillsDTO.Medicine)} type=\"text\"><input name=\"Medicine-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Nature\">Nature <span class=\"skill\">(Int)</span></label><input name=\"Nature\" value={Method.SkillBonus(AbilityDTO.IntMod, SkillsDTO.Nature)} type=\"text\"><input name=\"Nature-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Perception\">Perception <span class=\"skill\">(Wis)</span></label><input name=\"Perception\" value={Method.SkillBonus(AbilityDTO.WisMod, SkillsDTO.Perception)} type=\"text\"><input name=\"Perception-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Performance\">Performance <span class=\"skill\">(Cha)</span></label><input name=\"Performance\" value={Method.SkillBonus(AbilityDTO.ChaMod, SkillsDTO.Performance)} type=\"text\"><input name=\"Performance-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Persuasion\">Persuasion <span class=\"skill\">(Cha)</span></label><input name=\"Persuasion\" value={Method.SkillBonus(AbilityDTO.ChaMod, SkillsDTO.Persuasion)} type=\"text\"><input name=\"Persuasion-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Religion\">Religion <span class=\"skill\">(Int)</span></label><input name=\"Religion\" value={Method.SkillBonus(AbilityDTO.IntMod, SkillsDTO.Religion)} type=\"text\"><input name=\"Religion-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Sleight of Hand\">Sleight of Hand <span class=\"skill\">(Dex)</span></label><input name=\"Sleight of Hand\" value={Method.SkillBonus(AbilityDTO.DexMod, SkillsDTO.SleightofHand)} type=\"text\"><input name=\"Sleight of Hand-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Stealth\">Stealth <span class=\"skill\">(Dex)</span></label><input name=\"Stealth\" value={Method.SkillBonus(AbilityDTO.DexMod, SkillsDTO.Stealth)} type=\"text\"><input name=\"Stealth-prof\" type=\"checkbox\"></li>" +
            $"<li><label for=\"Survival\">Survival <span class=\"skill\">(Wis)</span></label><input name=\"Survival\" value={Method.SkillBonus(AbilityDTO.WisMod, SkillsDTO.Survival)} type=\"text\"><input name=\"Survival-prof\" type=\"checkbox\"></li>" +
            "</ul>" +
            "<div class=\"label\">Skills</div></div></div>" +
            "</section>" +
            $"<div class=\"passive-perception box\"><div class=\"label-container\"><label for=\"passiveperception\">Passive Wisdom (Perception)</label></div><input name=\"passiveperception\" value =\"{10 + AbilityDTO.WisMod}\"></div>" +
            ...
            "<div class=\"armorclass\"><div><label for=\"ac\">Armor Class</label><input name=\"ac\" value = \"12\" type=\"text\"></div></div>" +
            $"<div class=\"initiative\"><div><label for=\"initiative\">Initiative</label><input name=\"initiative\" value = \"{AbilityDTO.DexMod}\" type=\"text\"></div></div>" +
            $"<div class=\"speed\"><div><label for=\"speed\">Speed</label><input name=\"speed\" value = {RaceDTO.RaceSpeed} type=\"text\"></div></div>" +
            $"<div class=\"hp\"><div class=\"regular\"><div class=\"max\"><label for=\"maxhp\">Hit Point Maximum</label><input name=\"maxhp\" value = \"{CharacterDTO.HP}\" type=\"text\"></div> " +
            $"<div class=\"current\"><label for=\"currenthp\">Current Hit Points</label><input name=\"currenthp\" value = \"{CharacterDTO.HP}\" type=\"text\"></div></div>" +
            "<div class=\"temporary\"><label for=\"temphp\">Temporary Hit Points</label><input name=\"temphp\" type=\"text\"></div></div>" +
            $"<div class=\"hitdice\"><div><div class=\"total\"><label for=\"totalhd\">Total</label><input name=\"totalhd\" value = \"{CharacterDTO.CLvl}d{ClassDTO.ClassHitDice}\" type=\"text\"></div>" +
            $"<div class=\"remaining\"><label for=\"remaininghd\">Hit Dice</label><input name=\"remaininghd\" value = \"{CharacterDTO.CLvl}\" type=\"text\"></div></div></div>" +
