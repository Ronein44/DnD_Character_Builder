...
namespace DnD_CharacterBuilder_Library
{
    class SkillProfDTO
    {
        ...
        public static bool AnimalHandling { get; set; }
        public static bool Arcana { get; set; }
        ...
        public static bool Investigation { get; set; }
        public static bool Medicine { get; set; }
        public static bool Nature { get; set; }
        public static bool Perception { get; set; }
        public static bool Performance { get; set; }
        public static bool Persuasion { get; set; }
        public static bool Religion { get; set; }
        public static bool SleightofHand { get; set; }
